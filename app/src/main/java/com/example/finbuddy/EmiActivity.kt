...
class EmiActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val loanTenure = findViewById<EditText>(R.id.loanTenure)
        ...
        calculateButton.setOnClickListener {
            ...
            val tenure = loanTenure.text.toString().toDoubleOrNull()

            if (principal != null && rate != null && tenure != null) {
                val monthlyRate = rate / 12 / 100
                val numberOfMonths = tenure * 12
                ...
                resultText.text = String.format("Your Monthly EMI: %.2f", emi)
            } else {
